// ISO 4217 currency list. Hardcoded for portability; no npm dependency.
// AED is pinned to the top — it's this app's target currency.
// Otherwise the array is sorted alphabetically by code.
...
const REST: Currency[] = [
  ...
  { code: "ZWG", name: "Zimbabwean ZiG", symbol: "Z$" },
]
